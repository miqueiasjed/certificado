...
class RotinasAgendadasTest extends TestCase
{
    ...
    public function test_as_quatro_rotinas_estao_agendadas_no_fuso_do_negocio(): void
    {
        ...
        $this->assertCount(4, RotinasAgendadas::DIARIAS, 'a lista de rotinas diárias mudou de tamanho');
