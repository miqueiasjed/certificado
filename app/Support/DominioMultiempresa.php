...
final class DominioMultiempresa
{
    ...
    public const TABELAS_FORA_DO_ESCOPO = [
        ...
        'normative_references' => 'Referência normativa dos documentos emitidos (Plano 24); tem company_id nullable mas não usa o escopo global, porque a linha de company_id nulo é a referência padrão da plataforma e o escopo global (company_id = tenant) a esconderia, deixando o documento sem texto legal. A leitura é sempre por NormativeReference::daEmpresa()/resolver(), que filtram o tenant informado mais o padrão da plataforma.',
    ...
    public const MODELS_DE_DOMINIO = [
        ...
        \App\Models\PersonalProtectiveEquipment::class,
        \App\Models\PestSighting::class,
        \App\Models\PpeDelivery::class,
    ...
    public const MODELS_FORA_DO_ESCOPO = [
        ...
        \App\Models\NormativeReference::class => 'Referência normativa dos documentos emitidos (Plano 24); tem company_id nullable mas não usa o escopo global, porque a linha de company_id nulo é a referência padrão da plataforma e o escopo global (company_id = tenant) a esconderia, deixando o documento emitido sem texto legal. A leitura é sempre por NormativeReference::daEmpresa()/resolver(), que filtram o tenant informado mais o padrão da plataforma.',
