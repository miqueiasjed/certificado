  ...
  <AuthenticatedLayout>
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-6">
      <div class="flex-1 min-w-0">
        <h1 class="text-2xl font-bold text-gray-900 sm:text-3xl sm:truncate">Serviços</h1>
        <p class="mt-1 text-sm text-gray-600 sm:text-base">Gerencie todos os serviços cadastrados no sistema</p>
      </div>
