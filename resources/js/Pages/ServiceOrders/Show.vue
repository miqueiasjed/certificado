<template>
  <AuthenticatedLayout>
    ...
    <div class="max-w-4xl mx-auto space-y-6">
      ...
      <!-- Cômodos Atendidos -->
      <Card v-if="serviceOrder.rooms && serviceOrder.rooms.length > 0">
        <div class="px-6 py-4 border-b border-gray-200">
          <h3 class="text-lg font-medium text-gray-900">Cômodos Atendidos</h3>
        </div>
        <div class="p-6">
          <div class="space-y-3">
            <div v-for="room in serviceOrder.rooms" :key="room.id" class="border border-gray-200 rounded-lg p-4">
              <div class="flex items-start">
                ...
                <div class="flex-1">
                  ...
                  <div v-if="room.pivot?.observation" class="mt-1 text-sm text-gray-600">
                    <span class="font-medium">Observação:</span> {{ room.pivot.observation }}
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="flex justify-center space-x-4">
        <a :href="`/service-orders/${serviceOrder.id}/pdf`" target="_blank" class="btn-primary">
          <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
