            ...
            >
              ...
              <div class="flex items-center justify-center w-16 h-16 mx-auto mb-4 rounded-full"
                ...
                <svg class="w-8 h-8" :class="getIconColorClass(cadastro.color)" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <!-- Ícone de Calendário -->
                  <path v-else-if="cadastro.icon === 'calendar'" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
