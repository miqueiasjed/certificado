          ...
          <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
              <li class="inline-flex items-center">
                <Link :href="`/clients/${device.room?.address?.client?.id}`" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-green-600">
                  <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                  </svg>
                  {{ device.room?.address?.client?.name }}
                </Link>
              </li>
              <li>
                <div class="flex items-center">
                  ...
                  <Link :href="`/addresses/${device.room?.address?.id}`" class="ml-1 text-sm font-medium text-gray-700 hover:text-green-600 md:ml-2">
                    {{ device.room?.address?.nickname || 'Endereço' }}
                  </Link>
                </div>
              </li>
              <li>
                <div class="flex items-center">
                  ...
                  <Link :href="`/rooms/${device.room?.id}`" class="ml-1 text-sm font-medium text-gray-700 hover:text-green-600 md:ml-2">
                    {{ device.room?.name }}
                  </Link>
                </div>
              </li>
