    ...
    <template #header>
      ...
      >
        <template #actions>
          ...
          <!-- Encerrar também respeita `bloqueadoParaEdicao`: encerrar grava
               `end_date`, ou seja, muda a vigência do contrato que o cliente
               está lendo para assinar. Oferecer o botão aqui seria oferecer
               uma ação que o Service recusa. -->
          <button v-if="pode('contrato-editar') && !bloqueadoParaEdicao" type="button" class="btn-danger" @click="abrirEncerramento">
            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
