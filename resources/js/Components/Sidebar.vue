      ...
      <ul role="list" class="flex flex-1 flex-col gap-y-1">
        ...
        <li>
          <Link
            ...
            <svg :class="[
              isCurrentRoute('/devices') ? 'text-white' : 'text-green-300 group-hover:text-white',
              'h-5 w-5 shrink-0 transition-colors'
            ]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
            </svg>
            <span v-if="!collapsed">Dispositivos</span>
          </Link>
        </li>
        <li>
          <Link
            ...
            <svg :class="[
              isCurrentRoute('/products') ? 'text-white' : 'text-green-300 group-hover:text-white',
              'h-5 w-5 shrink-0 transition-colors'
            ]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
            </svg>
            <span v-if="!collapsed">Produtos</span>
          </Link>
        </li>
        <li>
          <Link
        ...
        <li>
          <Link
            :href="'/technicians'"
            :class="[
              isCurrentRoute('/technicians')
                ? 'bg-green-700 text-white'
                : 'text-green-100 hover:bg-green-700 hover:text-white',
              'group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 transition-colors'
            ]">
            <svg :class="[
              isCurrentRoute('/technicians') ? 'text-white' : 'text-green-300 group-hover:text-white',
              'h-5 w-5 shrink-0 transition-colors'
            ]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
            </svg>
            <span v-if="!collapsed">Técnicos</span>
          </Link>
        </li>
        <li>
          <Link
