<template>
  <div class="relative">
    ...
    <!-- Selected State -->
    <div v-if="modelValue" class="flex items-center justify-between p-2 border border-green-200 bg-green-50 rounded-md">
    ...
    <div v-else class="relative">
         <div class="relative">
            <input 
                ...
                class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm pl-10"
            />
